...
export class TenantController {
   ...
   * GET /api/tenants
   */
  async getAllTenants(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   * GET /api/tenants/:id
   */
  async getTenantById(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   * POST /api/tenants
   */
  async createTenant(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   * PUT /api/tenants/:id
   */
  async updateTenant(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (req.user?.role !== 'ADMIN') {
        throw new AppError('Admin access required', 403);
      }
   ...
   */
  async deleteTenant(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (req.user?.role !== 'ADMIN') {
        throw new AppError('Admin access required', 403);
      }
   ...
   */
  async moveTenantOut(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (req.user?.role !== 'ADMIN') {
        throw new AppError('Admin access required', 403);
      }
   ...
   */
  async moveTenantIn(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (req.user?.role !== 'ADMIN') {
        throw new AppError('Admin access required', 403);
      }
   ...
   */
  async getTenantsByRoom(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async getTenantStats(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (req.user?.role !== 'ADMIN') {
        throw new AppError('Admin access required', 403);
      }
   ...
   */
  async searchTenants(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
