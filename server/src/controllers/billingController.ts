...
export class BillingController {
   ...
   */
  async generateBillingRecord(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async calculateRealtimeBill(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async getBillingRecordById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async getBillingRecords(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userRole = req.user?.role || 'USER';
      const userId = req.user?.id;
   ...
   */
  async getRoomBillingHistory(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async markOverduePayments(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async getMonthlyFinancialReport(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userRole = req.user?.role || 'USER';
      const userId = req.user?.id;
   ...
   */
  async getYearlyFinancialReport(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userRole = req.user?.role || 'USER';
      const userId = req.user?.id;
   ...
   */
  async exportFinancialData(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userRole = req.user?.role || 'USER';
      const userId = req.user?.id;
