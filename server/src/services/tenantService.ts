...
export class TenantService {
   ...
   * Get tenant by ID
   */
  async getTenantById(id: string, userRole: string, userId?: string): Promise<TenantWithRoom | null> {
   ...
   */
  async createTenant(data: CreateTenantData): Promise<TenantWithRoom> {
   ...
   */
  async updateTenant(id: string, data: UpdateTenantData): Promise<TenantWithRoom> {
   ...
   */
  async moveTenantOut(id: string, moveOutDate?: Date): Promise<TenantWithRoom> {
   ...
   */
  async moveTenantIn(id: string, moveInDate?: Date): Promise<TenantWithRoom> {
    const tenant = await prisma.tenant.findUnique({
      where: { id },
      include: { 
        room: {
   ...
   */
  async getTenantsByRoom(roomId: number, userRole: string, userId?: string): Promise<TenantWithRoom[]> {
   ...
   */
  private async checkUserRoomAccess(userId: string, roomId: number): Promise<boolean> {
